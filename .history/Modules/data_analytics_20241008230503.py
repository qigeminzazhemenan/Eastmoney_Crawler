...
def is_recent_good(Table,Recent=5,Days=90):
    ...
    print('a'.Grpby.loc[:'Close'])
    Mask1 = abs(Grpby.loc[:,'Close']['Cov_first']) > 0.1
    Mask2 = Grpby.loc[:,'Price Change Rate']['min_last'] > -2
    Mask3 = Grpby.loc[:,'Price Change Rate']['max_last'] < 10
    Mask4 = Grpby.loc[:,'Price Change Rate']['mean_last'] > 3
    Mask5 = Grpby.loc[:,'Turnover']['mean_last'] > 2
