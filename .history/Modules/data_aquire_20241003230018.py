...
def get_k_history(Code: str, beg: str, end: str, klt: int = 101, adjust: int = 1) -> pd.DataFrame:
    ...
    try:
        ...
        logger.add('meet error when downloading kline info of stock {}, Error:{}'.format(Code,Error))
...
def get_foreign_holder_amount(Code: str) ->pd.DataFrame:
    ...
    return ForeignHolderAmount
        ...
        logger.add('meet error when downloading stockholders info of stock {}, Error:{}'.format(Code,Error))
