...
def main():
    ...
    if __name__ == "__main__":
        ...
        if os.listdir(DataPath):
            History = pd.read_csv(DataPath+os.listdir(DataPath)[0].format(DataPath,os.listdir(DataPath)[0]))
