...
if __name__ == "__main__":
    ...
    #get SSE Composite-----
    CodeSSE = "000001"
    KLineSSE = get_k_history(CodeSSEComposite, StartDate, EndDate)
    ...
    SSECTable = '{}\\SZ{}.csv'.format(DataPath,EndDate)
    KLineSSEComposite.to_csv(SSETable,encoding='utf-8-sig')
